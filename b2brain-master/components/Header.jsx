...
const Header = ({ searchAcc, searching, setSearching, searchTerm, setSearchTerm }) => {
  ...
  return (
    <header className="bg-white pl-[50px] md:px-4  h-[50px] py-3 px-4 flex items-center w-full shadow-lg shadow-slate-400/10">
      ...
      <input
        onClick={() => { setSearching(true); setToggle(false) }}
        onKeyDown={(e) => {
